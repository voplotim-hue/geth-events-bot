...
- Анкета пользователя после `/start`: дата рождения, фамилия, имя, отчество и церковь.
...
Привязывает Telegram-пользователя к строке в `Users` и запускает анкету в личном чате. Бот по шагам спросит дату рождения, фамилию, имя, отчество и церковь, покажет сводку и сохранит данные в карточку после кнопки `Отправить`.
